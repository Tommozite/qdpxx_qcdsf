 ...
 */
    ...
    struct QDPProfileInfo_t
    {
        ...
        QDPProfileInfo_t(const QDPProfileInfo_t &a) : level(a.level), file(a.file), caller(a.caller), line(a.line) {}

        QDPProfileInfo_t(int _level, const std::string &_file, const std::string &_caller, int _line) : level(_level), file(_file), caller(_caller), line(_line) {}
    };
 ...
 */
  ...
  Print_t::apply(t, PrintTag(os), PrintTag(os), NullTag());
    ...
    // FnSpinProjectDir0PlusFull
    template <>
    struct TagVisitor<FnSpinProjectDir0PlusFull, PrintTag> : public ParenPrinter<FnSpinProjectDir0PlusFull>
    {
        static void visit(FnSpinProjectDir0PlusFull op, PrintTag t)
        {
            t.os_m << "spinProjectDir0PlusFull";
        }
    };

    // FnSpinProjectDir1PlusFull
    template <>
    struct TagVisitor<FnSpinProjectDir1PlusFull, PrintTag> : public ParenPrinter<FnSpinProjectDir1PlusFull>
    {
        static void visit(FnSpinProjectDir1PlusFull op, PrintTag t)
        {
            t.os_m << "spinProjectDir1PlusFull";
        }
    };

    // FnSpinProjectDir2PlusFull
    template <>
    struct TagVisitor<FnSpinProjectDir2PlusFull, PrintTag> : public ParenPrinter<FnSpinProjectDir2PlusFull>
    {
        static void visit(FnSpinProjectDir2PlusFull op, PrintTag t)
        {
            t.os_m << "spinProjectDir2PlusFull";
        }
    };

    // FnSpinProjectDir3PlusFull
    template <>
    struct TagVisitor<FnSpinProjectDir3PlusFull, PrintTag> : public ParenPrinter<FnSpinProjectDir3PlusFull>
    {
        static void visit(FnSpinProjectDir3PlusFull op, PrintTag t)
        {
            t.os_m << "spinProjectDir3PlusFull";
        }
    };

    // FnSpinProjectDir0MinusFull
    template <>
    struct TagVisitor<FnSpinProjectDir0MinusFull, PrintTag> : public ParenPrinter<FnSpinProjectDir0MinusFull>
    {
        static void visit(FnSpinProjectDir0MinusFull op, PrintTag t)
        {
            t.os_m << "spinProjectDir0MinusFull";
        }
    };

    // FnSpinProjectDir1MinusFull
    template <>
    struct TagVisitor<FnSpinProjectDir1MinusFull, PrintTag> : public ParenPrinter<FnSpinProjectDir1MinusFull>
    {
        static void visit(FnSpinProjectDir1MinusFull op, PrintTag t)
        {
            t.os_m << "spinProjectDir1MinusFull";
        }
    };

    // FnSpinProjectDir2MinusFull
    template <>
    struct TagVisitor<FnSpinProjectDir2MinusFull, PrintTag> : public ParenPrinter<FnSpinProjectDir2MinusFull>
    {
        static void visit(FnSpinProjectDir2MinusFull op, PrintTag t)
        {
            t.os_m << "spinProjectDir2MinusFull";
        }
    };

    // FnSpinProjectDir3MinusFull
    template <>
    struct TagVisitor<FnSpinProjectDir3MinusFull, PrintTag> : public ParenPrinter<FnSpinProjectDir3MinusFull>
    {
        static void visit(FnSpinProjectDir3MinusFull op, PrintTag t)
        {
            t.os_m << "spinProjectDir3MinusFull";
        }
    };

    // FnSpinReconstructDir0PlusFull
    template <>
    struct TagVisitor<FnSpinReconstructDir0PlusFull, PrintTag> : public ParenPrinter<FnSpinReconstructDir0PlusFull>
    {
        static void visit(FnSpinReconstructDir0PlusFull op, PrintTag t)
        {
            t.os_m << "spinReconstructDir0PlusFull";
        }
    };

    // FnSpinReconstructDir1PlusFull
    template <>
    struct TagVisitor<FnSpinReconstructDir1PlusFull, PrintTag> : public ParenPrinter<FnSpinReconstructDir1PlusFull>
    {
        static void visit(FnSpinReconstructDir1PlusFull op, PrintTag t)
        {
            t.os_m << "spinReconstructDir1PlusFull";
        }
    };

    // FnSpinReconstructDir2PlusFull
    template <>
    struct TagVisitor<FnSpinReconstructDir2PlusFull, PrintTag> : public ParenPrinter<FnSpinReconstructDir2PlusFull>
    {
        static void visit(FnSpinReconstructDir2PlusFull op, PrintTag t)
        {
            t.os_m << "spinReconstructDir2PlusFull";
        }
    };

    // FnSpinReconstructDir3PlusFull
    template <>
    struct TagVisitor<FnSpinReconstructDir3PlusFull, PrintTag> : public ParenPrinter<FnSpinReconstructDir3PlusFull>
    {
        static void visit(FnSpinReconstructDir3PlusFull op, PrintTag t)
        {
            t.os_m << "spinReconstructDir3PlusFull";
        }
    };

    // FnSpinReconstructDir0MinusFull
    template <>
    struct TagVisitor<FnSpinReconstructDir0MinusFull, PrintTag> : public ParenPrinter<FnSpinReconstructDir0MinusFull>
    {
        static void visit(FnSpinReconstructDir0MinusFull op, PrintTag t)
        {
            t.os_m << "spinReconstructDir0MinusFull";
        }
    };

    // FnSpinReconstructDir1MinusFull
    template <>
    struct TagVisitor<FnSpinReconstructDir1MinusFull, PrintTag> : public ParenPrinter<FnSpinReconstructDir1MinusFull>
    {
        static void visit(FnSpinReconstructDir1MinusFull op, PrintTag t)
        {
            t.os_m << "spinReconstructDir1MinusFull";
        }
    };

    // FnSpinReconstructDir2MinusFull
    template <>
    struct TagVisitor<FnSpinReconstructDir2MinusFull, PrintTag> : public ParenPrinter<FnSpinReconstructDir2MinusFull>
    {
        static void visit(FnSpinReconstructDir2MinusFull op, PrintTag t)
        {
            t.os_m << "spinReconstructDir2MinusFull";
        }
    };

    // FnSpinReconstructDir3MinusFull
    template <>
    struct TagVisitor<FnSpinReconstructDir3MinusFull, PrintTag> : public ParenPrinter<FnSpinReconstructDir3MinusFull>
    {
        static void visit(FnSpinReconstructDir3MinusFull op, PrintTag t)
        {
            t.os_m << "spinReconstructDir3MinusFull";
        }
    };
