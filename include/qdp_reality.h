  ...
  RScalar& operator=(const typename WordType<T>::Type_t& rhs)
    {
      ...
      return *this;
        ...
        template <class T1>
        inline RScalar &operator=(const RScalar<T1> &rhs)
        {
            elem() = rhs.elem();
            return *this;
        }
    ...
    //! Ascii input
    template <class T>
    inline std::istream &operator>>(std::istream &s, RScalar<T> &d)
    {
        return s >> d.elem();
    }
    ...
    //! Ascii input
    template <class T>
    inline StandardInputStream &operator>>(StandardInputStream &s, RScalar<T> &d)
    {
        return s >> d.elem();
    }
    ...
    //! Ascii output
    template <class T>
    inline std::ostream &operator<<(std::ostream &s, const RScalar<T> &d)
    {
        return s << d.elem();
    }
    ...
    //! Ascii output
    template <class T>
    inline StandardOutputStream &operator<<(StandardOutputStream &s, const RScalar<T> &d)
    {
        return s << d.elem();
    }
    ...
    //! Text input
    template <class T>
    inline TextReader &operator>>(TextReader &s, RScalar<T> &d)
    {
        return s >> d.elem();
    }
    ...
    //! Text output
    template <class T>
    inline TextWriter &operator<<(TextWriter &s, const RScalar<T> &d)
    {
        return s << d.elem();
    }
    ...
    //! XML output
    template <class T>
    inline XMLWriter &operator<<(XMLWriter &xml, const RScalar<T> &d)
    {
        return xml << d.elem();
    }
    ...
    //! XML input
    template <class T>
    inline void read(XMLReader &xml, const std::string &path, RScalar<T> &d)
    {
 ...
 */
    ...
    public:
        ...
        template <class T1>
        inline RComplex &operator=(const RScalar<T1> &rhs)
        {
            real() = rhs.elem();
            zero_rep(imag());
            return *this;
        ...
        template <class T1>
        inline RComplex &operator=(const RComplex<T1> &rhs)
        {
            real() = rhs.real();
            imag() = rhs.imag();
            return *this;
    ...
    //! Stream output
    template <class T>
    inline std::ostream &operator<<(std::ostream &s, const RComplex<T> &d)
    {
        s << "( " << d.real() << " , " << d.imag() << " )";
        return s;
    }
    ...
    //! Stream output
    template <class T>
    inline StandardOutputStream &operator<<(StandardOutputStream &s, const RComplex<T> &d)
    {
        s << "( " << d.real() << " , " << d.imag() << " )";
        return s;
    }
    ...
    //! Text input
    template <class T>
    inline TextReader &operator>>(TextReader &s, RComplex<T> &d)
    {
    ...
    //! Text output
    template <class T>
    inline TextWriter &operator<<(TextWriter &s, const RComplex<T> &d)
    {
        return s << d.real() << d.imag();
    }
    ...
    //! XML output
    template <class T>
    inline XMLWriter &operator<<(XMLWriter &xml, const RComplex<T> &d)
    {
        xml.openTag("re");
        xml << d.real();
        xml.closeTag();
    ...
    //! XML input
    template <class T>
    inline void read(XMLReader &xml, const std::string &xpath, RComplex<T> &d)
    {
 ...
 */
    ...
    inline void copymask(RScalar<T> &d, const RScalar<T1> &mask, const RScalar<T> &s1)
    {
    ...
    template <class T, class T1>
    inline void cast_rep(T &d, const RScalar<T1> &s1)
    {
        cast_rep(d, s1.elem());
    }
    ...
    //! dest [float type] = source [int type]
    template <class T, class T1>
    inline void recast_rep(RScalar<T> &d, const RScalar<T1> &s1)
    {
 ...
 */
    ...
    //! dest = 0
    template <class T>
    inline void zero_rep(RScalar<T> &dest)
    {
        zero_rep(dest.elem());
    }
 ...
 */
    ...
    // RComplex = i * RScalar
    template <class T>
    struct UnaryReturn<RScalar<T>, FnTimesILambda>
    {
        typedef RComplex<typename UnaryReturn<T, FnTimesILambda>::Type_t> Type_t;
    };

    template <class T>
    inline typename UnaryReturn<RScalar<T>, FnTimesILambda>::Type_t
    timesILambda(const RScalar<T> &s1)
    {
        typename UnaryReturn<RScalar<T>, FnTimesILambda>::Type_t d;

        zero_rep(d.real());
        d.imag() = (1 + lambda) * s1.elem();
        return d;
    }
    // RComplex = i * RComplex
    template <class T>
    inline typename UnaryReturn<RComplex<T>, FnTimesILambda>::Type_t
    timesILambda(const RComplex<T> &s1)
    {
        typedef typename UnaryReturn<RComplex<T>, FnTimesILambda>::Type_t Ret_t;

        return Ret_t(-(1 + lambda) * s1.imag(),
                     (1 + lambda) * s1.real());
    }

    // RComplex = i * RScalar
    template <class T>
    struct UnaryReturn<RScalar<T>, FnTimesLambda>
    {
        typedef RComplex<typename UnaryReturn<T, FnTimesLambda>::Type_t> Type_t;
    };

    template <class T>
    inline typename UnaryReturn<RScalar<T>, FnTimesLambda>::Type_t
    timesLambda(const RScalar<T> &s1)
    {
        typename UnaryReturn<RScalar<T>, FnTimesLambda>::Type_t d;

        zero_rep(d.imag());
        d.real() = (1 + lambda) * s1.elem();
        return d;
    }
    // RComplex = i * RComplex
    template <class T>
    inline typename UnaryReturn<RComplex<T>, FnTimesLambda>::Type_t
    timesLambda(const RComplex<T> &s1)
    {
        typedef typename UnaryReturn<RComplex<T>, FnTimesLambda>::Type_t Ret_t;

        return Ret_t((1 + lambda) * s1.real(),
                     (1 + lambda) * s1.imag());
    }

    // RComplex = -i * RScalar
    template <class T>
    struct UnaryReturn<RScalar<T>, FnTimesMinusILambda>
    {
        typedef RComplex<typename UnaryReturn<T, FnTimesMinusILambda>::Type_t> Type_t;
    };

    template <class T>
    inline typename UnaryReturn<RScalar<T>, FnTimesMinusILambda>::Type_t
    timesMinusILambda(const RScalar<T> &s1)
    {
        typename UnaryReturn<RScalar<T>, FnTimesMinusILambda>::Type_t d;
    ...
    // RComplex = -i * RComplex
    template <class T>
    inline typename UnaryReturn<RComplex<T>, FnTimesMinusILambda>::Type_t
    timesMinusILambda(const RComplex<T> &s1)
    {
        typedef typename UnaryReturn<RComplex<T>, FnTimesMinusILambda>::Type_t Ret_t;
    ...
    // RComplex = i * RScalar
    template <class T>
    struct UnaryReturn<RScalar<T>, FnTimesILambdaThird>
    {
        typedef RComplex<typename UnaryReturn<T, FnTimesILambdaThird>::Type_t> Type_t;
    };

    template <class T>
    inline typename UnaryReturn<RScalar<T>, FnTimesILambdaThird>::Type_t
    timesILambdaThird(const RScalar<T> &s1)
    {
        typename UnaryReturn<RScalar<T>, FnTimesILambdaThird>::Type_t d;

        zero_rep(d.real());
        d.imag() = (1 - lambda / 3.) * s1.elem();
        return d;
    }

    // RComplex = i * RComplex
    template <class T>
    inline typename UnaryReturn<RComplex<T>, FnTimesILambdaThird>::Type_t
    timesILambdaThird(const RComplex<T> &s1)
    {
        typedef typename UnaryReturn<RComplex<T>, FnTimesILambdaThird>::Type_t Ret_t;

        return Ret_t(-(1 - lambda / 3.) * s1.imag(),
                     (1 - lambda / 3.) * s1.real());
    }

    // RComplex = i * RScalar
    template <class T>
    struct UnaryReturn<RScalar<T>, FnTimesLambdaThird>
    {
        typedef RComplex<typename UnaryReturn<T, FnTimesLambdaThird>::Type_t> Type_t;
    };

    template <class T>
    inline typename UnaryReturn<RScalar<T>, FnTimesLambdaThird>::Type_t
    timesLambdaThird(const RScalar<T> &s1)
    {
        typename UnaryReturn<RScalar<T>, FnTimesLambdaThird>::Type_t d;

        zero_rep(d.imag());
        d.real() = (1 - lambda / 3.) * s1.elem();
        return d;
    }

    // RComplex = i * RComplex
    template <class T>
    inline typename UnaryReturn<RComplex<T>, FnTimesLambdaThird>::Type_t
    timesLambdaThird(const RComplex<T> &s1)
    {
        typedef typename UnaryReturn<RComplex<T>, FnTimesLambdaThird>::Type_t Ret_t;

        return Ret_t((1 - lambda / 3.) * s1.real(),
                     (1 - lambda / 3.) * s1.imag());
    }

    // RComplex = -i * RScalar
    template <class T>
    struct UnaryReturn<RScalar<T>, FnTimesMinusILambdaThird>
    {
        typedef RComplex<typename UnaryReturn<T, FnTimesMinusILambdaThird>::Type_t> Type_t;
    };

    template <class T>
    inline typename UnaryReturn<RScalar<T>, FnTimesMinusILambdaThird>::Type_t
    timesMinusILambdaThird(const RScalar<T> &s1)
    {
        typename UnaryReturn<RScalar<T>, FnTimesMinusILambdaThird>::Type_t d;
    ...
    // RComplex = -i * RComplex
    template <class T>
    inline typename UnaryReturn<RComplex<T>, FnTimesMinusILambdaThird>::Type_t
    timesMinusILambdaThird(const RComplex<T> &s1)
    {
        typedef typename UnaryReturn<RComplex<T>, FnTimesMinusILambdaThird>::Type_t Ret_t;
    ...
    //! dest = (mask) ? s1 : dest
    template <class T, class T1>
    inline void copymask(RComplex<T> &d, const RScalar<T1> &mask, const RComplex<T> &s1)
    {
 ...
 */
    ...
    //! dest = 0
    template <class T>
    inline void zero_rep(RComplex<T> &dest)
    {
        zero_rep(dest.real());
        zero_rep(dest.imag());
    }
