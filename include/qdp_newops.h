...
namespace QDP
{
    ...
    struct FnSpinProjectFull
    {
        PETE_EMPTY_CONSTRUCTORS(FnSpinProjectFull)
    };

    struct FnSpinReconstructFull
    {
        PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructFull)
    };
  ...
  @relates QDPType */
    ...
    struct CreateLeaf<GammaType<N>>
    {
        ...
        inline static Leaf_t make(const Input_t &a) { return Leaf_t(a); }
    };
