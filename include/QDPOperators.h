...
struct FnTimesILambda
{
    PETE_EMPTY_CONSTRUCTORS(FnTimesILambda)
    template <class T>
    inline typename UnaryReturn<T, FnTimesILambda>::Type_t
    operator()(const T &a) const
    {
        return (timesILambda(a));
    }
};

struct FnTimesLambda
{
    PETE_EMPTY_CONSTRUCTORS(FnTimesLambda)
    template <class T>
    inline typename UnaryReturn<T, FnTimesLambda>::Type_t
    operator()(const T &a) const
    {
        return (timesLambda(a));
    }
};

struct FnTimesMinusILambda
{
    PETE_EMPTY_CONSTRUCTORS(FnTimesMinusILambda)
    template <class T>
    inline typename UnaryReturn<T, FnTimesMinusILambda>::Type_t
    operator()(const T &a) const
    {
        return (timesMinusILambda(a));
    }
};

struct FnTimesILambdaThird
{
    PETE_EMPTY_CONSTRUCTORS(FnTimesILambdaThird)
    template <class T>
    inline typename UnaryReturn<T, FnTimesILambdaThird>::Type_t
    operator()(const T &a) const
    {
        return (timesILambdaThird(a));
    }
};

struct FnTimesLambdaThird
{
    PETE_EMPTY_CONSTRUCTORS(FnTimesLambdaThird)
    template <class T>
    inline typename UnaryReturn<T, FnTimesLambdaThird>::Type_t
    operator()(const T &a) const
    {
        return (timesLambdaThird(a));
    }
};

struct FnTimesMinusILambdaThird
{
    PETE_EMPTY_CONSTRUCTORS(FnTimesMinusILambdaThird)
    template <class T>
    inline typename UnaryReturn<T, FnTimesMinusILambdaThird>::Type_t
    operator()(const T &a) const
    {
        return (timesMinusILambdaThird(a));
    }
};
...
struct FnSpinProjectDir0PlusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinProjectDir0PlusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinProjectDir0PlusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinProjectDir0PlusFull(a));
    }
};

struct FnSpinProjectDir1PlusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinProjectDir1PlusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinProjectDir1PlusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinProjectDir1PlusFull(a));
    }
};

struct FnSpinProjectDir2PlusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinProjectDir2PlusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinProjectDir2PlusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinProjectDir2PlusFull(a));
    }
};

struct FnSpinProjectDir3PlusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinProjectDir3PlusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinProjectDir3PlusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinProjectDir3PlusFull(a));
    }
};

struct FnSpinProjectDir0MinusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinProjectDir0MinusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinProjectDir0MinusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinProjectDir0MinusFull(a));
    }
};

struct FnSpinProjectDir1MinusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinProjectDir1MinusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinProjectDir1MinusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinProjectDir1MinusFull(a));
    }
};

struct FnSpinProjectDir2MinusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinProjectDir2MinusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinProjectDir2MinusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinProjectDir2MinusFull(a));
    }
};

struct FnSpinProjectDir3MinusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinProjectDir3MinusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinProjectDir3MinusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinProjectDir3MinusFull(a));
    }
};

struct FnSpinReconstructDir0PlusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructDir0PlusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinReconstructDir0PlusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinReconstructDir0PlusFull(a));
    }
};

struct FnSpinReconstructDir1PlusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructDir1PlusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinReconstructDir1PlusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinReconstructDir1PlusFull(a));
    }
};

struct FnSpinReconstructDir2PlusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructDir2PlusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinReconstructDir2PlusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinReconstructDir2PlusFull(a));
    }
};

struct FnSpinReconstructDir3PlusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructDir3PlusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinReconstructDir3PlusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinReconstructDir3PlusFull(a));
    }
};

struct FnSpinReconstructDir0MinusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructDir0MinusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinReconstructDir0MinusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinReconstructDir0MinusFull(a));
    }
};

struct FnSpinReconstructDir1MinusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructDir1MinusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinReconstructDir1MinusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinReconstructDir1MinusFull(a));
    }
};

struct FnSpinReconstructDir2MinusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructDir2MinusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinReconstructDir2MinusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinReconstructDir2MinusFull(a));
    }
};

struct FnSpinReconstructDir3MinusFull
{
    PETE_EMPTY_CONSTRUCTORS(FnSpinReconstructDir3MinusFull)
    template <class T>
    inline typename UnaryReturn<T, FnSpinReconstructDir3MinusFull>::Type_t
    operator()(const T &a) const
    {
        return (spinReconstructDir3MinusFull(a));
    }
};
//////
//////
...
/*! Returns half-spin vector from a full spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinProjectDir0PlusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir0PlusFull>::Type_t>::Expression_t
spinProjectDir0PlusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir0PlusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinProjectDir0PlusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns half-spin vector from a full spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinProjectDir1PlusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir1PlusFull>::Type_t>::Expression_t
spinProjectDir1PlusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir1PlusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinProjectDir1PlusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns half-spin vector from a full spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinProjectDir2PlusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir2PlusFull>::Type_t>::Expression_t
spinProjectDir2PlusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir2PlusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinProjectDir2PlusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns half-spin vector from a full spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinProjectDir3PlusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir3PlusFull>::Type_t>::Expression_t
spinProjectDir3PlusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir3PlusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinProjectDir3PlusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns half-spin vector from a full spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinProjectDir0MinusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir0MinusFull>::Type_t>::Expression_t
spinProjectDir0MinusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir0MinusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinProjectDir0MinusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns half-spin vector from a full spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinProjectDir1MinusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir1MinusFull>::Type_t>::Expression_t
spinProjectDir1MinusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir1MinusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinProjectDir1MinusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns half-spin vector from a full spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinProjectDir2MinusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir2MinusFull>::Type_t>::Expression_t
spinProjectDir2MinusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir2MinusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinProjectDir2MinusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns half-spin vector from a full spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinProjectDir3MinusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir3MinusFull>::Type_t>::Expression_t
spinProjectDir3MinusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir3MinusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinProjectDir3MinusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns full spin vector from a half spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir0PlusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir0PlusFull>::Type_t>::Expression_t
spinReconstructDir0PlusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir0PlusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinReconstructDir0PlusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns full-spin vector from a half-spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir1PlusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir1PlusFull>::Type_t>::Expression_t
spinReconstructDir1PlusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir1PlusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinReconstructDir1PlusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns full-spin vector from a half-spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir2PlusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir2PlusFull>::Type_t>::Expression_t
spinReconstructDir2PlusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir2PlusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinReconstructDir2PlusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns full-spin vector from a half-spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir3PlusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir3PlusFull>::Type_t>::Expression_t
spinReconstructDir3PlusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir3PlusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinReconstructDir3PlusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns full-spin vector from a half-spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir0MinusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir0MinusFull>::Type_t>::Expression_t
spinReconstructDir0MinusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir0MinusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinReconstructDir0MinusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns full-spin vector from a half-spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir1MinusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir1MinusFull>::Type_t>::Expression_t
spinReconstructDir1MinusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir1MinusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinReconstructDir1MinusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns full-spin vector from a half-spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir2MinusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir2MinusFull>::Type_t>::Expression_t
spinReconstructDir2MinusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir2MinusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinReconstructDir2MinusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
...
/*! Returns full-spin vector from a half-spin vector source
  ...
  @relates QDPType */
template <class T1, class C1>
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir3MinusFull,
                                     typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir3MinusFull>::Type_t>::Expression_t
spinReconstructDir3MinusFull(const QDPType<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir3MinusFull,
                      typename CreateLeaf<QDPType<T1, C1>>::Leaf_t>
        Tree_t;
    typedef typename UnaryReturn<C1, FnSpinReconstructDir3MinusFull>::Type_t Container_t;
    return MakeReturn<Tree_t, Container_t>::make(Tree_t(
        CreateLeaf<QDPType<T1, C1>>::make(l)));
}
//////
...
inline typename MakeReturn<UnaryNode<FnSpinProjectDir0PlusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir0PlusFull>::Type_t>::Expression_t
spinProjectDir0PlusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir0PlusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinProjectDir1PlusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir1PlusFull>::Type_t>::Expression_t
spinProjectDir1PlusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir1PlusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinProjectDir2PlusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir2PlusFull>::Type_t>::Expression_t
spinProjectDir2PlusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir2PlusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinProjectDir3PlusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir3PlusFull>::Type_t>::Expression_t
spinProjectDir3PlusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir3PlusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinProjectDir0MinusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir0MinusFull>::Type_t>::Expression_t
spinProjectDir0MinusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir0MinusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinProjectDir1MinusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir1MinusFull>::Type_t>::Expression_t
spinProjectDir1MinusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir1MinusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinProjectDir2MinusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir2MinusFull>::Type_t>::Expression_t
spinProjectDir2MinusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir2MinusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinProjectDir3MinusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinProjectDir3MinusFull>::Type_t>::Expression_t
spinProjectDir3MinusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinProjectDir3MinusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir0PlusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir0PlusFull>::Type_t>::Expression_t
spinReconstructDir0PlusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir0PlusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir1PlusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir1PlusFull>::Type_t>::Expression_t
spinReconstructDir1PlusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir1PlusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir2PlusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir2PlusFull>::Type_t>::Expression_t
spinReconstructDir2PlusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir2PlusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir3PlusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir3PlusFull>::Type_t>::Expression_t
spinReconstructDir3PlusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir3PlusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir0MinusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir0MinusFull>::Type_t>::Expression_t
spinReconstructDir0MinusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir0MinusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir1MinusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir1MinusFull>::Type_t>::Expression_t
spinReconstructDir1MinusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir1MinusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir2MinusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir2MinusFull>::Type_t>::Expression_t
spinReconstructDir2MinusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir2MinusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
...
inline typename MakeReturn<UnaryNode<FnSpinReconstructDir3MinusFull,
                                     typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>,
                           typename UnaryReturn<C1, FnSpinReconstructDir3MinusFull>::Type_t>::Expression_t
spinReconstructDir3MinusFull(const QDPExpr<T1, C1> &l)
{
    typedef UnaryNode<FnSpinReconstructDir3MinusFull,
                      typename CreateLeaf<QDPExpr<T1, C1>>::Leaf_t>
        Tree_t;
