...
namespace QDP
{
    ...
    template <>
    struct BinaryReturn<QDPType<PScalar<ColMat>, OScalar<PScalar<ColMat>>>,
                        QDPType<Spin4, OScalar<Spin4>>,
                        OpMultiply>
    {
        typedef OScalar<Spin4> Type_t;
    };
    ...
    template <>
    struct BinaryReturn<QDPType<PScalar<ColMat>, OLattice<PScalar<ColMat>>>,
                        QDPType<Spin4, OLattice<Spin4>>,
                        OpMultiply>
    {
        typedef OLattice<Spin4> Type_t;
    };
    ...
    //
    /////////////////////////////////////////////////////////////////////////
    /// Reconstruct Dir0MinusFull Fused
    /////////////////////////////////////////////////////////////////////////
    struct FnSReconDir0MinusFullProd
    {
        PETE_EMPTY_CONSTRUCTORS(FnSReconDir0MinusFullProd)

        template <class T1, class T2, int N>
        inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir0MinusFullProd>::Type_t
        operator()(const PScalar<T1> &a, const PSpinVector<T2, N> &b) const
        {
            return sreconDir0MinusFull(a, b);
        }
    };
    ...
    // of the SpinReconstruction on a normal half vector
    template <class T1, class T2, int N>
    struct BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir0MinusFullProd>
    {
        typedef typename UnaryReturn<PSpinVector<T2, N>, FnSpinReconstructDir0MinusFull>::Type_t Type_t;
    };
    ...
    template <class T1, class T2, int N>
    inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir0MinusFullProd>::Type_t
    sreconDir0MinusFull(const PScalar<T1> &a, const PSpinVector<T2, N> &b)
    {
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, OpMultiply>::Type_t tmp;
        tmp = a * b;
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir0MinusFullProd>::Type_t ret;
        ret = spinReconstructDir0MinusFull(tmp);
        return ret;
    }

    // This rewrites spinReconstructDir0MinusFull( Matrix * Vec )
    // as a fused reconstruct: FnSReconDir0MinusFullProd< Matrix, Vec >
    template <class T1, class T2, template <class> class C, int N>
    inline typename MakeReturn<BinaryNode<FnSReconDir0MinusFullProd,
                                          typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                                          typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>,
                               typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir0MinusFullProd>::Type_t>::Expression_t
    spinReconstructDir0MinusFull(const QDPExpr<
                                 BinaryNode<OpMultiply,
                                            Reference<QDPType<PScalar<T1>, C<PScalar<T1>>>>,
                                            Reference<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>>,
                                 typename BinaryReturn<QDPType<PScalar<T1>, C<PScalar<T1>>>,
                                                       ...
                                                       OpMultiply>::Type_t> &l)
    {
        ...
        typedef BinaryNode<FnSReconDir0MinusFullProd,
                           typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                           typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>
            Tree_t;

        return MakeReturn<Tree_t, typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir0MinusFullProd>::Type_t>::make(
            Tree_t(
                CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::make(l.expression().left()),
                CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::make(l.expression().right())));
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    /// Reconstruct Dir0PlusFull Fused
    /////////////////////////////////////////////////////////////////////////
    struct FnSReconDir0PlusFullProd
    {
        PETE_EMPTY_CONSTRUCTORS(FnSReconDir0PlusFullProd)

        template <class T1, class T2, int N>
        inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir0PlusFullProd>::Type_t
        operator()(const PScalar<T1> &a, const PSpinVector<T2, N> &b) const
        {
            return sreconDir0PlusFull(a, b);
        }
    };
    ...
    // of the SpinReconstruction on a normal half vector
    template <class T1, class T2, int N>
    struct BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir0PlusFullProd>
    {
        typedef typename UnaryReturn<PSpinVector<T2, N>, FnSpinReconstructDir0PlusFull>::Type_t Type_t;
    };
    ...
    template <class T1, class T2, int N>
    inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir0PlusFullProd>::Type_t
    sreconDir0PlusFull(const PScalar<T1> &a, const PSpinVector<T2, N> &b)
    {
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, OpMultiply>::Type_t tmp;
        tmp = a * b;
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir0PlusFullProd>::Type_t ret;
        ret = spinReconstructDir0PlusFull(tmp);
        return ret;
    }

    // This rewrites spinReconstructDir0PlusFull( Matrix * Vec )
    // as a fused reconstruct: FnSReconDir0PlusFullProd< Matrix, Vec >
    template <class T1, class T2, template <class> class C, int N>
    inline typename MakeReturn<BinaryNode<FnSReconDir0PlusFullProd,
                                          typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                                          typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>,
                               typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir0PlusFullProd>::Type_t>::Expression_t
    spinReconstructDir0PlusFull(const QDPExpr<
                                BinaryNode<OpMultiply,
                                           Reference<QDPType<PScalar<T1>, C<PScalar<T1>>>>,
                                           Reference<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>>,
                                typename BinaryReturn<QDPType<PScalar<T1>, C<PScalar<T1>>>,
                                                      ...
                                                      OpMultiply>::Type_t> &l)
    {
        ...
        typedef BinaryNode<FnSReconDir0PlusFullProd,
                           typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                           typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>
            Tree_t;

        return MakeReturn<Tree_t, typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir0PlusFullProd>::Type_t>::make(
            Tree_t(
                CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::make(l.expression().left()),
                CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::make(l.expression().right())));
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    /// Reconstruct Dir1MinusFull Fused
    /////////////////////////////////////////////////////////////////////////
    struct FnSReconDir1MinusFullProd
    {
        PETE_EMPTY_CONSTRUCTORS(FnSReconDir1MinusFullProd)

        template <class T1, class T2, int N>
        inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir1MinusFullProd>::Type_t
        operator()(const PScalar<T1> &a, const PSpinVector<T2, N> &b) const
        {
            return sreconDir1MinusFull(a, b);
        }
    };
    ...
    // of the SpinReconstruction on a normal half vector
    template <class T1, class T2, int N>
    struct BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir1MinusFullProd>
    {
        typedef typename UnaryReturn<PSpinVector<T2, N>, FnSpinReconstructDir1MinusFull>::Type_t Type_t;
    };
    ...
    template <class T1, class T2, int N>
    inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir1MinusFullProd>::Type_t
    sreconDir1MinusFull(const PScalar<T1> &a, const PSpinVector<T2, N> &b)
    {
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, OpMultiply>::Type_t tmp;
        tmp = a * b;
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir1MinusFullProd>::Type_t ret;
        ret = spinReconstructDir1MinusFull(tmp);
        return ret;
    }

    // This rewrites spinReconstructDir1MinusFull( Matrix * Vec )
    // as a fused reconstruct: FnSReconDir1MinusFullProd< Matrix, Vec >
    template <class T1, class T2, template <class> class C, int N>
    inline typename MakeReturn<BinaryNode<FnSReconDir1MinusFullProd,
                                          typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                                          typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>,
                               typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir1MinusFullProd>::Type_t>::Expression_t
    spinReconstructDir1MinusFull(const QDPExpr<
                                 BinaryNode<OpMultiply,
                                            Reference<QDPType<PScalar<T1>, C<PScalar<T1>>>>,
                                            Reference<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>>,
                                 typename BinaryReturn<QDPType<PScalar<T1>, C<PScalar<T1>>>,
                                                       ...
                                                       OpMultiply>::Type_t> &l)
    {
        ...
        typedef BinaryNode<FnSReconDir1MinusFullProd,
                           typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                           typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>
            Tree_t;

        return MakeReturn<Tree_t, typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir1MinusFullProd>::Type_t>::make(
            Tree_t(
                CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::make(l.expression().left()),
                CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::make(l.expression().right())));
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    /// Reconstruct Dir1PlusFull Fused
    /////////////////////////////////////////////////////////////////////////
    struct FnSReconDir1PlusFullProd
    {
        PETE_EMPTY_CONSTRUCTORS(FnSReconDir1PlusFullProd)

        template <class T1, class T2, int N>
        inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir1PlusFullProd>::Type_t
        operator()(const PScalar<T1> &a, const PSpinVector<T2, N> &b) const
        {
            return sreconDir1PlusFull(a, b);
        }
    };
    ...
    // of the SpinReconstruction on a normal half vector
    template <class T1, class T2, int N>
    struct BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir1PlusFullProd>
    {
        typedef typename UnaryReturn<PSpinVector<T2, N>, FnSpinReconstructDir1PlusFull>::Type_t Type_t;
    };
    ...
    template <class T1, class T2, int N>
    inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir1PlusFullProd>::Type_t
    sreconDir1PlusFull(const PScalar<T1> &a, const PSpinVector<T2, N> &b)
    {
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, OpMultiply>::Type_t tmp;
        tmp = a * b;
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir1PlusFullProd>::Type_t ret;
        ret = spinReconstructDir1PlusFull(tmp);
        return ret;
    }

    // This rewrites spinReconstructDir1PlusFull( Matrix * Vec )
    // as a fused reconstruct: FnSReconDir1PlusFullProd< Matrix, Vec >
    template <class T1, class T2, template <class> class C, int N>
    inline typename MakeReturn<BinaryNode<FnSReconDir1PlusFullProd,
                                          typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                                          typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>,
                               typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir1PlusFullProd>::Type_t>::Expression_t
    spinReconstructDir1PlusFull(const QDPExpr<
                                BinaryNode<OpMultiply,
                                           Reference<QDPType<PScalar<T1>, C<PScalar<T1>>>>,
                                           Reference<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>>,
                                typename BinaryReturn<QDPType<PScalar<T1>, C<PScalar<T1>>>,
                                                      ...
                                                      OpMultiply>::Type_t> &l)
    {
        ...
        typedef BinaryNode<FnSReconDir1PlusFullProd,
                           typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                           typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>
            Tree_t;

        return MakeReturn<Tree_t, typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir1PlusFullProd>::Type_t>::make(
            Tree_t(
                CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::make(l.expression().left()),
                CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::make(l.expression().right())));
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    /// Reconstruct Dir2MinusFull Fused
    /////////////////////////////////////////////////////////////////////////
    struct FnSReconDir2MinusFullProd
    {
        PETE_EMPTY_CONSTRUCTORS(FnSReconDir2MinusFullProd)

        template <class T1, class T2, int N>
        inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir2MinusFullProd>::Type_t
        operator()(const PScalar<T1> &a, const PSpinVector<T2, N> &b) const
        {
            return sreconDir2MinusFull(a, b);
        }
    };
    ...
    // of the SpinReconstruction on a normal half vector
    template <class T1, class T2, int N>
    struct BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir2MinusFullProd>
    {
        typedef typename UnaryReturn<PSpinVector<T2, N>, FnSpinReconstructDir2MinusFull>::Type_t Type_t;
    };
    ...
    template <class T1, class T2, int N>
    inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir2MinusFullProd>::Type_t
    sreconDir2MinusFull(const PScalar<T1> &a, const PSpinVector<T2, N> &b)
    {
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, OpMultiply>::Type_t tmp;
        tmp = a * b;
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir2MinusFullProd>::Type_t ret;
        ret = spinReconstructDir2MinusFull(tmp);
        return ret;
    }

    // This rewrites spinReconstructDir2MinusFull( Matrix * Vec )
    // as a fused reconstruct: FnSReconDir2MinusFullProd< Matrix, Vec >
    template <class T1, class T2, template <class> class C, int N>
    inline typename MakeReturn<BinaryNode<FnSReconDir2MinusFullProd,
                                          typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                                          typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>,
                               typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir2MinusFullProd>::Type_t>::Expression_t
    spinReconstructDir2MinusFull(const QDPExpr<
                                 BinaryNode<OpMultiply,
                                            Reference<QDPType<PScalar<T1>, C<PScalar<T1>>>>,
                                            Reference<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>>,
                                 typename BinaryReturn<QDPType<PScalar<T1>, C<PScalar<T1>>>,
                                                       ...
                                                       OpMultiply>::Type_t> &l)
    {
        ...
        typedef BinaryNode<FnSReconDir2MinusFullProd,
                           typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                           typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>
            Tree_t;

        return MakeReturn<Tree_t, typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir2MinusFullProd>::Type_t>::make(
            Tree_t(
                CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::make(l.expression().left()),
                CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::make(l.expression().right())));
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    /// Reconstruct Dir2PlusFull Fused
    /////////////////////////////////////////////////////////////////////////
    struct FnSReconDir2PlusFullProd
    {
        PETE_EMPTY_CONSTRUCTORS(FnSReconDir2PlusFullProd)

        template <class T1, class T2, int N>
        inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir2PlusFullProd>::Type_t
        operator()(const PScalar<T1> &a, const PSpinVector<T2, N> &b) const
        {
            return sreconDir2PlusFull(a, b);
        }
    };
    ...
    // of the SpinReconstruction on a normal half vector
    template <class T1, class T2, int N>
    struct BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir2PlusFullProd>
    {
        typedef typename UnaryReturn<PSpinVector<T2, N>, FnSpinReconstructDir2PlusFull>::Type_t Type_t;
    };
    ...
    template <class T1, class T2, int N>
    inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir2PlusFullProd>::Type_t
    sreconDir2PlusFull(const PScalar<T1> &a, const PSpinVector<T2, N> &b)
    {
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, OpMultiply>::Type_t tmp;
        tmp = a * b;
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir2PlusFullProd>::Type_t ret;
        ret = spinReconstructDir2PlusFull(tmp);
        return ret;
    }

    // This rewrites spinReconstructDir2PlusFull( Matrix * Vec )
    // as a fused reconstruct: FnSReconDir2PlusFullProd< Matrix, Vec >
    template <class T1, class T2, template <class> class C, int N>
    inline typename MakeReturn<BinaryNode<FnSReconDir2PlusFullProd,
                                          typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                                          typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>,
                               typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir2PlusFullProd>::Type_t>::Expression_t
    spinReconstructDir2PlusFull(const QDPExpr<
                                BinaryNode<OpMultiply,
                                           Reference<QDPType<PScalar<T1>, C<PScalar<T1>>>>,
                                           Reference<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>>,
                                typename BinaryReturn<QDPType<PScalar<T1>, C<PScalar<T1>>>,
                                                      ...
                                                      OpMultiply>::Type_t> &l)
    {
        ...
        typedef BinaryNode<FnSReconDir2PlusFullProd,
                           typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                           typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>
            Tree_t;

        return MakeReturn<Tree_t, typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir2PlusFullProd>::Type_t>::make(
            Tree_t(
                CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::make(l.expression().left()),
                CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::make(l.expression().right())));
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    /// Reconstruct Dir3MinusFull Fused
    /////////////////////////////////////////////////////////////////////////
    struct FnSReconDir3MinusFullProd
    {
        PETE_EMPTY_CONSTRUCTORS(FnSReconDir3MinusFullProd)

        template <class T1, class T2, int N>
        inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir3MinusFullProd>::Type_t
        operator()(const PScalar<T1> &a, const PSpinVector<T2, N> &b) const
        {
            return sreconDir3MinusFull(a, b);
        }
    };
    ...
    // of the SpinReconstruction on a normal half vector
    template <class T1, class T2, int N>
    struct BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir3MinusFullProd>
    {
        typedef typename UnaryReturn<PSpinVector<T2, N>, FnSpinReconstructDir3MinusFull>::Type_t Type_t;
    };
    ...
    template <class T1, class T2, int N>
    inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir3MinusFullProd>::Type_t
    sreconDir3MinusFull(const PScalar<T1> &a, const PSpinVector<T2, N> &b)
    {
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, OpMultiply>::Type_t tmp;
        tmp = a * b;
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir3MinusFullProd>::Type_t ret;
        ret = spinReconstructDir3MinusFull(tmp);
        return ret;
    }

    // This rewrites spinReconstructDir3MinusFull( Matrix * Vec )
    // as a fused reconstruct: FnSReconDir3MinusFullProd< Matrix, Vec >
    template <class T1, class T2, template <class> class C, int N>
    inline typename MakeReturn<BinaryNode<FnSReconDir3MinusFullProd,
                                          typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                                          typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>,
                               typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir3MinusFullProd>::Type_t>::Expression_t
    spinReconstructDir3MinusFull(const QDPExpr<
                                 BinaryNode<OpMultiply,
                                            Reference<QDPType<PScalar<T1>, C<PScalar<T1>>>>,
                                            Reference<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>>,
                                 typename BinaryReturn<QDPType<PScalar<T1>, C<PScalar<T1>>>,
                                                       ...
                                                       OpMultiply>::Type_t> &l)
    {
        ...
        typedef BinaryNode<FnSReconDir3MinusFullProd,
                           typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                           typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>
            Tree_t;

        return MakeReturn<Tree_t, typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir3MinusFullProd>::Type_t>::make(
            Tree_t(
                CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::make(l.expression().left()),
                CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::make(l.expression().right())));
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    /// Reconstruct Dir3PlusFull Fused
    /////////////////////////////////////////////////////////////////////////
    struct FnSReconDir3PlusFullProd
    {
        PETE_EMPTY_CONSTRUCTORS(FnSReconDir3PlusFullProd)

        template <class T1, class T2, int N>
        inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir3PlusFullProd>::Type_t
        operator()(const PScalar<T1> &a, const PSpinVector<T2, N> &b) const
        {
            return sreconDir3PlusFull(a, b);
        }
    };
    ...
    // of the SpinReconstruction on a normal half vector
    template <class T1, class T2, int N>
    struct BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir3PlusFullProd>
    {
        typedef typename UnaryReturn<PSpinVector<T2, N>, FnSpinReconstructDir3PlusFull>::Type_t Type_t;
    };
    ...
    template <class T1, class T2, int N>
    inline typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir3PlusFullProd>::Type_t
    sreconDir3PlusFull(const PScalar<T1> &a, const PSpinVector<T2, N> &b)
    {
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, OpMultiply>::Type_t tmp;
        tmp = a * b;
        typename BinaryReturn<PScalar<T1>, PSpinVector<T2, N>, FnSReconDir3PlusFullProd>::Type_t ret;
        ret = spinReconstructDir3PlusFull(tmp);
        return ret;
    }

    // This rewrites spinReconstructDir3PlusFull( Matrix * Vec )
    // as a fused reconstruct: FnSReconDir3PlusFullProd< Matrix, Vec >
    template <class T1, class T2, template <class> class C, int N>
    inline typename MakeReturn<BinaryNode<FnSReconDir3PlusFullProd,
                                          typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                                          typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>,
                               typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir3PlusFullProd>::Type_t>::Expression_t
    spinReconstructDir3PlusFull(const QDPExpr<
                                BinaryNode<OpMultiply,
                                           Reference<QDPType<PScalar<T1>, C<PScalar<T1>>>>,
                                           Reference<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>>,
                                typename BinaryReturn<QDPType<PScalar<T1>, C<PScalar<T1>>>,
                                                      ...
                                                      OpMultiply>::Type_t> &l)
    {
        ...
        typedef BinaryNode<FnSReconDir3PlusFullProd,
                           typename CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::Leaf_t,
                           typename CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::Leaf_t>
            Tree_t;

        return MakeReturn<Tree_t, typename BinaryReturn<C<PScalar<T1>>, C<PSpinVector<T2, N>>, FnSReconDir3PlusFullProd>::Type_t>::make(
            Tree_t(
                CreateLeaf<QDPType<PScalar<T1>, C<PScalar<T1>>>>::make(l.expression().left()),
                CreateLeaf<QDPType<PSpinVector<T2, N>, C<PSpinVector<T2, N>>>>::make(l.expression().right())));
    }
