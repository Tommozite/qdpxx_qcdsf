 ...
 */
    ...
    public:
        ...
        template <class T1>
        inline CC &assign(const C<T1, N> &rhs)
        {
            for (int i = 0; i < N; ++i)
                elem(i) = rhs.elem(i);
        ...
        /*! Set equal to another PVector */
        template <class T1>
        inline CC &operator=(const C<T1, N> &rhs)
        {
            return assign(rhs);
        }
        ...
        //! PVector *= PScalar
        template <class T1>
        inline CC &operator*=(const PScalar<T1> &rhs)
        {
            for (int i = 0; i < N; ++i)
                elem(i) *= rhs.elem();
  ...
  PVector(const PVector& a)
    ...
    //! Stream input
    template <class T, int N, template <class, int> class C>
    inline std::istream &operator>>(std::istream &s, PVector<T, N, C> &d)
    {
        for (int i = 0; i < N; ++i)
            s >> d.elem(i);
    ...
    template <class T, int N, template <class, int> class C>
    inline StandardInputStream &operator>>(StandardInputStream &s, PVector<T, N, C> &d)
    {
        for (int i = 0; i < N; ++i)
            s >> d.elem(i);
    ...
    //! Stream output
    template <class T, int N, template <class, int> class C>
    inline std::ostream &operator<<(std::ostream &s, const PVector<T, N, C> &d)
    {
        for (int i = 0; i < N; ++i)
            s << d.elem(i);
    ...
    //! Stream output
    template <class T, int N, template <class, int> class C>
    inline StandardOutputStream &operator<<(StandardOutputStream &s, const PVector<T, N, C> &d)
    {
        for (int i = 0; i < N; ++i)
            s << d.elem(i);
    ...
    //! Text input
    template <class T, int N, template <class, int> class C>
    inline TextReader &operator>>(TextReader &txt, PVector<T, N, C> &d)
    {
        for (int i = 0; i < N; ++i)
            txt >> d.elem(i);
    ...
    //! Text output
    template <class T, int N, template <class, int> class C>
    inline TextWriter &operator<<(TextWriter &txt, const PVector<T, N, C> &d)
    {
        for (int i = 0; i < N; ++i)
            txt << d.elem(i);
    ...
    //! XML output
    template <class T, int N, template <class, int> class C>
    inline XMLWriter &operator<<(XMLWriter &xml, const PVector<T, N, C> &d)
    {
        xml.openTag("Vector");
...
//  typedef T1 Type_t;
    ...
    //! PVector = i * (1+lambda) * PVector
    template <class T, int N, template <class, int> class C>
    inline typename UnaryReturn<PVector<T, N, C>, FnTimesILambda>::Type_t
    timesILambda(const PVector<T, N, C> &s1)
    {
        typename UnaryReturn<PVector<T, N, C>, FnTimesILambda>::Type_t d;
    ...
    //! PVector = i * (1+lambda) * PVector
    template <class T, int N, template <class, int> class C>
    inline typename UnaryReturn<PVector<T, N, C>, FnTimesLambda>::Type_t
    timesLambda(const PVector<T, N, C> &s1)
    {
        typename UnaryReturn<PVector<T, N, C>, FnTimesLambda>::Type_t d;
    ...
    //! PVector = -i * (1+lambda) * PVector
    template <class T, int N, template <class, int> class C>
    inline typename UnaryReturn<PVector<T, N, C>, FnTimesMinusILambda>::Type_t
    timesMinusILambda(const PVector<T, N, C> &s1)
    {
        typename UnaryReturn<PVector<T, N, C>, FnTimesMinusILambda>::Type_t d;
    ...
    //! PVector = i * (1-lambda/3) * PVector
    template <class T, int N, template <class, int> class C>
    inline typename UnaryReturn<PVector<T, N, C>, FnTimesILambdaThird>::Type_t
    timesILambdaThird(const PVector<T, N, C> &s1)
    {
        typename UnaryReturn<PVector<T, N, C>, FnTimesILambdaThird>::Type_t d;
    ...
    //! PVector = i * (1-lambda/3) * PVector
    template <class T, int N, template <class, int> class C>
    inline typename UnaryReturn<PVector<T, N, C>, FnTimesLambdaThird>::Type_t
    timesLambdaThird(const PVector<T, N, C> &s1)
    {
        typename UnaryReturn<PVector<T, N, C>, FnTimesLambdaThird>::Type_t d;
    ...
    //! PVector = -i * (1-lambda/3) * PVector
    template <class T, int N, template <class, int> class C>
    inline typename UnaryReturn<PVector<T, N, C>, FnTimesMinusILambdaThird>::Type_t
    timesMinusILambdaThird(const PVector<T, N, C> &s1)
    {
        typename UnaryReturn<PVector<T, N, C>, FnTimesMinusILambdaThird>::Type_t d;
